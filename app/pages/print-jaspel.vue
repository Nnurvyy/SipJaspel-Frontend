  ...
  <div class="page">
    <div class="section-header" style="display:flex; justify-content:space-between; align-items:flex-end;">
      <div>
        ...
        <p>Cetak lembar Jasa Pelayanan per kategori & Unduh Excel — Januari 2026</p>
      </div>
      <div>
    ...
    <div class="grid-2" v-else-if="!error">
      <div class="card" style="cursor:pointer;transition:box-shadow .2s" onmouseover="this.style.boxShadow='var(--shadow-lg)'" onmouseout="this.style.boxShadow=''">
...
const exportUrl = `${config.public.apiBase}/export/rekap/2026-01`;
